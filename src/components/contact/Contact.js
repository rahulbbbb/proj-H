                ...
                <div className='contact__content'>
                    ...
                    <div className='contact__info'>
                        <div className='contact__card'>
                            ...
                            <span className='contact__card-data'>Novatechsolution@gmail.com</span>
                        ...
                        <div className='contact__card'>
                            ...
                            <span className='contact__card-data'>+9189203851XX</span>

                            <a href="https://t.me/shadmankhan" className='contact__button'>Write Us <i className='bx bx-right-arrow-alt contact_-button-icon'></i></a>
                        </div>
                        ...
                        <div className='contact__card'>
                            ...
                            <span className='contact__card-data'>Tech_Nova</span>

                            <a href="https://www.instagram.com/being_bankoti/" className='contact__button'>Write Us <i className='bx bx-right-arrow-alt contact_-button-icon'></i></a>
                        </div>
                    </div>
                </div>
